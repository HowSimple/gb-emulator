...
void CPU::execute_opcode(u8 opcode)
{
	switch (opcode)
	{
	case 0xCB: { execute_cb_opcode(get_byte()); break; }
	...
	case 0x06: { op_ld(reg.b, get_byte());						cycles += 8;	break; }
	case 0x07: { op_rlca();										cycles += 4;	break; }
	case 0x08: { write_mem_16(get_word(), reg.sp);				cycles += 20;	break; }
	...
	case 0x0E: { op_ld(reg.c, get_byte());						cycles += 8;	break; }
	case 0x0F: { op_rrca();										cycles += 4;	break; }
	case 0x10: { op_stop();										cycles += 4;	break; }
	case 0x11: { op_ld(reg.de, get_word());						cycles += 12;	break; }
	...
	case 0x18: { op_jr(get_signed_byte());						cycles += 12;	break; }
	...
	case 0x1E: { op_ld(reg.c, get_byte());						cycles += 8;	break; }
	case 0x1F: { op_rra();										cycles += 4;	break; }
	case 0x20: { op_jrc(!reg.get_zero());						cycles += 12;	break; }
	case 0x21: { op_ld(reg.hl, get_word());						cycles += 12;	break; }
	...
	case 0x26: { op_ld(reg.h, get_byte());						cycles += 8;	break; }
	...
	case 0x2E: { op_ld(reg.c, get_byte());						cycles += 8;	break; }
	case 0x2F: { op_rrca();										cycles += 4;	break; }
	case 0x30: { op_jrc(!reg.get_carry());						cycles += 12;	break; }
	case 0x31: { op_ld(reg.sp, get_word());						cycles += 12;	break; }
	...
	case 0x36: { write_mem(reg.hl, get_byte());					cycles += 12;	break; }
	...
	case 0x3E: { op_ld(reg.a, get_byte());						cycles += 8;	break; }
	...
	case 0xCE: { op_adc(reg.a, get_byte());						cycles += 8;	break; }
	...
	case 0xE6: { op_and(get_byte());							cycles += 8;	break; }
	case 0xE7: { op_rst(0x20);									cycles += 32;	break; }
	case 0xE8: { op_add(reg.sp, get_signed_byte());				cycles += 16;	break; }
	case 0xE9: { op_jp(reg.hl);									cycles += 4;	break; }
	...
	case 0xEE: { op_xor(get_byte());							cycles += 8;	break; }
	case 0xEF: { op_rst(0x28);									cycles += 32;	break; }
	case 0xF0: { op_ld(reg.a, read_mem(0xFF00 + get_byte()));	cycles += 12;	break; }
	...
	case 0xF6: { op_or(get_byte());								cycles += 8;	break; }
	case 0xF7: { op_rst(0x30);									cycles += 32;	break; }
	case 0xF8: { op_ld(reg.hl, get_signed_byte() + reg.sp);		cycles += 12;	break; }
	case 0xF9: { op_ld(reg.sp, reg.hl);							cycles += 8;	break; }
	case 0xFA: { op_ld(reg.a, read_mem(get_word()));			cycles += 16;	break; }
	case 0xFB: { op_ei();										cycles += 4;	break; }
		
	case 0xFE: { op_cp(get_byte());								cycles += 16;	break; }
