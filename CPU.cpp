...
u8 CPU::get_d8() // get 8-bit immediate value from RAM
{
	cycles += 4;

	return (mem.ram[pc++]);
}
u16 CPU::get_d16()	// get 16-bit immediate value from RAM
{
	cycles += 4;
	u16 immediate_16_bit_value = mem.ram[pc + 1] | (mem.ram[pc + 2] << 8);

	return immediate_16_bit_value;
}
s8 CPU::get_s8() // get signed 8-bit immediate value from RAM
{
	cycles += 4;
...
void CPU::execute_cb_opcode(u1 opcode)
{
	...
	case 0x06: {	op_rlc(mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x0E: {	op_rrc(mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x16: {	op_rl(mem.ram[hl]);				cycles += 16; break; }
	...
	case 0x1E: {	op_rr(mem.ram[hl]);				cycles += 16; break; }
	...
	case 0x26: {	op_sla(mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x2E: {	op_sra(mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x36: {	op_swap(mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x3E: {	op_srl(mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x46: {	op_bit(0, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x4E: {	op_bit(1, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x56: {	op_bit(2, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x5E: {	op_bit(3, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x66: {	op_bit(4, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x6E: {	op_bit(5, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x76: {	op_bit(6, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x7E: {	op_bit(7, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x86: {	op_res(0, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x8E: {	op_res(1, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x96: {	op_res(2, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0x9E: {	op_res(3, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xA6: {	op_res(4, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xAE: {	op_res(5, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xB6: {	op_res(6, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xBE: {	op_res(7, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xC6: {	op_set(0, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xCE: {	op_set(1, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xD6: {	op_set(2, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xDE: {	op_set(3, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xE6: {	op_set(4, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xEE: {	op_set(5, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xF6: {	op_set(6, mem.ram[hl]);			cycles += 16; break; }
	...
	case 0xFE: {	op_set(7, mem.ram[hl]);			cycles += 16; break; }
...
void CPU::execute_opcode(u1 opcode)
{
	...
	case 0x02: { op_ld(mem.ram[bc], a);					cycles += 8;	break; }
	...
	case 0x0A: { op_ld(a, mem.ram[bc]);					cycles += 8;	break; }
	...
	case 0x12: { op_ld(mem.ram[de], a);					cycles += 8;	break; }
	...
	case 0x18: { op_jr(get_s8());						cycles += 12;	break; }
	case 0x19: { op_add(hl, de);						cycles += 8;	break; }
	case 0x1A: { op_ld(a, mem.ram[de]);					cycles += 8;	break; }
	...
	case 0x22: { op_ld(mem.ram[hl], a); hl++;			cycles += 8;	break; }
	...
	case 0x29: { op_add(hl, bc);						cycles += 8;	break; }
	case 0x2A: { op_ld(a, mem.ram[hl]); hl++;			cycles += 8;	break; }
	case 0x2B: { op_dec(bc);							cycles += 8;	break; }
	case 0x2C: { op_inc(c);								cycles += 4;	break; }
	case 0x2D: { op_dec(c);								cycles += 4;	break; }
	case 0x2E: { op_ld(c, get_d8());					cycles += 8;	break; }
	case 0x2F: { op_rrca();								cycles += 4;	break; }
	case 0x30: { op_jr(NC);								cycles += 12;	break; }
	case 0x31: { op_ld(sp, get_d16());					cycles += 12;	break; }
	case 0x32: { op_ld(mem.ram[hl], a); hl--;			cycles += 8;	break; }
	case 0x33: { op_inc(sp);							cycles += 8;	break; }
	case 0x34: { op_inc(mem.ram[hl]);					cycles += 12;	break; }
	case 0x35: { op_dec(mem.ram[hl]);					cycles += 12;	break; }
	case 0x36: { op_ld(mem.ram[hl], get_d8());			cycles += 12;	break; }
	case 0x37: { op_scf();								cycles += 4;	break; }
	case 0x38: { op_jr(C);								cycles += 12;	break; }
	case 0x39: { op_add(hl, sp);						cycles += 8;	break; }
	case 0x3A: { op_ld(a, mem.ram[hl]); hl--;			cycles += 8;	break; }
	case 0x3B: { op_dec(sp);							cycles += 4;	break; }
	case 0x3C: { op_inc(a);								cycles += 4;	break; }
	case 0x3D: { op_dec(a);								cycles += 4;	break; }
	case 0x3E: { op_ld(a, get_d8());					cycles += 8;	break; }
	case 0x3F: { op_ccf();								cycles += 4;	break; }
	case 0x40: { op_ld(b, b);							cycles += 4;	break; }
	case 0x41: { op_ld(b, c);							cycles += 4;	break; }
	case 0x42: { op_ld(b, d);							cycles += 4;	break; }
	case 0x43: { op_ld(b, e);							cycles += 4;	break; }
	case 0x44: { op_ld(b, b);							cycles += 4;	break; }
	case 0x45: { op_ld(b, l);							cycles += 4;	break; }
	case 0x46: { op_ld(b, mem.ram[hl]);					cycles += 8;	break; }
	...
	case 0x4E: { op_ld(c, mem.ram[hl]);					cycles += 8;	break; }
	...
	case 0x56: { op_ld(d, mem.ram[hl]);					cycles += 8;	break; }
	...
	case 0x5E: { op_ld(e, mem.ram[hl]);					cycles += 8;	break; }
	...
	case 0x66: { op_ld(h, mem.ram[hl]);					cycles += 8;	break; }
	...
	case 0x6E: { op_ld(l, mem.ram[hl]);					cycles += 8;	break; }
	case 0x6F: { op_ld(l, a);							cycles += 4;	break; }
	case 0x70: { op_ld(mem.ram[hl], b);					cycles += 8;	break; }
	case 0x71: { op_ld(mem.ram[hl], c);					cycles += 8;	break; }
	case 0x72: { op_ld(mem.ram[hl], d);					cycles += 8;	break; }
	case 0x73: { op_ld(mem.ram[hl], e);					cycles += 8;	break; }
	case 0x74: { op_ld(mem.ram[hl], h);					cycles += 8;	break; }
	case 0x75: { op_ld(mem.ram[hl], l);					cycles += 8;	break; }
	case 0x76: { op_halt();								cycles += 4;	break; }
	case 0x77: { op_ld(mem.ram[hl], a);					cycles += 8;	break; }
	...
	case 0x7C: { op_ld(a, h);							cycles += 4;	break; }
	case 0x7D: { op_ld(a, l);							cycles += 4;	break; }
	case 0x7E: { op_ld(a, mem.ram[hl]);					cycles += 8;	break; }
	case 0x7F: { op_ld(a, a);							cycles += 4;	break; }
	...
	case 0x86: { op_add(a, mem.ram[hl]);				cycles += 8;	break; }
	...
	case 0x8E: { op_adc(a, mem.ram[hl]);				cycles += 8;	break; }
	...
	case 0x96: { op_sub(a, mem.ram[hl]);				cycles += 8;	break; }
	...
	case 0x9E: { op_sbc(a, mem.ram[hl]);				cycles += 8;	break; }
	...
	case 0xA6: { op_and(mem.ram[hl]);					cycles += 4;	break; }
	...
	case 0xAE: { op_xor(mem.ram[hl]);					cycles += 8;	break; }
	...
	case 0xB6: { op_or(mem.ram[hl]);					cycles += 8;	break; }
	...
	case 0xBE: { op_cp(mem.ram[hl]);					cycles += 8;	break; }
	case 0xBF: { op_cp(a);								cycles += 4;	break; }
	case 0xC0: { op_ret(NZ);							cycles += 20;	break; }
	case 0xC1: { op_pop(bc);							cycles += 12;	break; }
	case 0xC2: { op_jp(NZ);								cycles += 16;	break; }
	case 0xC3: { op_jp();								cycles += 16;	break; }
	case 0xC4: { op_call(NZ);							cycles += 24;	break; }
	case 0xC5: { op_push(bc);							cycles += 16;	break; }
	case 0xC6: { op_add(a, get_d8());					cycles += 8;	break; }
	case 0xC7: { op_rst(get_d8());						cycles += 16;	break; }
	...
	case 0xCE: { op_adc(a, get_d8());					cycles += 8;	break; }
	case 0xCF: { op_rst(get_d8());						cycles += 16;	break; }
	case 0xD0: { op_ret(NC);							cycles += 20;	break; }
	case 0xD1: { op_pop(de);							cycles += 12;	break; }
	case 0xD2: { op_jp(NC);								cycles += 16;	break; }
	//	 0xD3 is an undefined opcode
	case 0xD4: { op_call(NC);							cycles += 24;	break; }
	case 0xD5: { op_push(de);							cycles += 16;	break; }
	case 0xD6: { op_sub(a, get_d8());					cycles += 8;	break; }
	case 0xD7: { op_rst(get_d8());						cycles += 16;	break; }
	...
	case 0xDE: { op_sbc(a, get_d8());					cycles += 8;	break; }
	case 0xDF: { op_rst(get_d8());						cycles += 16;	break; }
	case 0xE0: { op_ld(mem.ram[0xFF00 + get_d8()], a);	cycles += 12;	break; }
	case 0xE1: { op_pop(hl);							cycles += 12;	break; }
	case 0xE2: { op_ld(mem.ram[0xFF00 + c], a);			cycles += 16;	break; }
	//   0xE3 is an undefined opcode
	case 0xE4: { op_undefined();										break; }
	case 0xE5: { op_push(hl);							cycles += 16;	break; }
	case 0xE6: { op_and(get_d8());						cycles += 8;	break; }
	case 0xE7: { op_rst(get_d8());						cycles += 16;	break; }
	case 0xE8: { op_add(sp, (get_s8()));				cycles += 16;	break; }
	case 0xE9: { op_jp(mem.ram[hl]);					cycles += 4;	break; }
	...
	case 0xEE: { op_xor(get_d8());						cycles += 8;	break; }
	case 0xEF: { op_rst(get_d8()); cycles += 16; break; }
//TODO:	case 0xF0: { op_ldh(a, a8); cycles += 12; break; }
	case 0xF1: { op_pop(de);							cycles += 12;	break; }
	case 0xF2: { op_ld(a, mem.ram[0xFF00 + c]);			cycles += 8;	break; }
	case 0xF3: { op_di();								cycles += 4;	break; }
	//   0xF4  is an undefined opcode
	case 0xF5: { op_push(af);							cycles += 16;	break; }
	case 0xF6: { op_or(get_d8());						cycles += 8;	break; }
	case 0xF7: { op_rst(get_d8());						cycles += 16;	break; }
//TODO: case 0xF8: { op_ld(hl, (get_s8() + sp); cycles += 12; break; }
	case 0xF9: { op_ld(sp, hl);							cycles += 8;	break; }
	case 0xFA: { op_ld(a, get_d16());					cycles += 16;	break; }
	case 0xFB: { op_ei();								cycles += 4;	break; }
	//	 0xFC is an undefined opcode
	//	 0xFD is an undefined opcode
	case 0xFE: { op_cp(get_d8());						cycles += 16;	break; }
	case 0xFF: { op_rst(get_d8());						cycles += 16;	break; }
